...
private:
  ...
  public:
    ...
    findOrCreate(const envoy::config::core::v3::ConfigSource& sds_config_source,
      ...
      std::cout << "findOrCreate 1 XXXXXXXXXXXXX : " << "config_name:" << config_name <<  std::endl;
      std::cout << "findOrCreate 1 XXXXXXXXXXXXX : " << "sds_config_source:" << sds_config_source.path_config_source().path() <<  std::endl;
